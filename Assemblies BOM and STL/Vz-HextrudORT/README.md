### Helical version will use the same back plate, same front cover, same hardware except the 2 feed gears (helical). The main body and tension arm are different.
